...
0#I2C 0#Enet 0#Enet 0}\
  ...
  connect_bd_intf_net -intf_net S_AXI_HP0_0_1 [get_bd_intf_ports S_AXI_HP0] [get_bd_intf_pins ps7/S_AXI_HP0]
  ...
  connect_bd_intf_net -intf_net ps7_M_AXI_GP0 [get_bd_intf_ports M_AXI_GP0] [get_bd_intf_pins ps7/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net M_AXI_GP0_ACLK_0_1 [get_bd_ports M_AXI_GP0_ACLK] [get_bd_pins ps7/M_AXI_GP0_ACLK]
  connect_bd_net -net S_AXI_HP0_ACLK_1 [get_bd_ports S_AXI_HP0_ACLK] [get_bd_pins ps7/S_AXI_HP0_ACLK]
  ...
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces S_AXI_HP0] [get_bd_addr_segs ps7/S_AXI_HP0/HP0_DDR_LOWOCM] -force
