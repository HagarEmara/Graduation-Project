...
HD_PWD='/home/mahmoudsamy/grad/ZC702/ztachip_zc702/ztachip_zc702.runs/zynq_bd_ps7_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_bd_ps7_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_bd_ps7_0.tcl
